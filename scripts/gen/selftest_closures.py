...
## 两侧：正例断言 + 反例注入
    ...
    python3 scripts/gen/selftest_closures.py             # 正例：150 条断言全绿，约 1 秒
    python3 scripts/gen/selftest_closures.py --negative  # 反例：66 个缺陷注入全红，约 9 秒
...
# ============================================================ 反例一侧（--negative）
#
# 为什么要有这一侧：上面 150 条 `ok()` **全部是正向的**，而本项目已经把「比的两端不
